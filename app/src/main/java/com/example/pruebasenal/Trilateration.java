...
//                               * Math.PI/180;
        ...
        static double getLongitude(Dispositivo d1, Dispositivo d2, Dispositivo d3)
                                   ...
                                   double Lat3, double Long3, double rssi3) */
        {
           ...
           // dist3 = calDistToDeg(calcDistance(d3.getRssi()));
            ...
            MyLong = (2*(d3.getLatitud()-d1.getLatitud())*(Math.pow(dist2,2)-Math.pow(dist1,2))
                    ...
                    / (4*(d2.getLatitud()-d1.getLatitud())*(d3.getLongitud()-d1.getLongitud())-4*(d3.getLatitud()-d1.getLatitud()*(d2.getLongitud() -d1.getLongitud())));

            return MyLong;
        }

        static double getLatitude(Dispositivo d1, Dispositivo d2, Dispositivo d3) {
            ...
            MyLat = (2*(d2.getLongitud()-d1.getLongitud())*(Math.pow(dist3,2)-Math.pow(dist1,2))
                    - 2*(d3.getLatitud()-d1.getLatitud())*(Math.pow(dist2,2)-Math.pow(dist1,2)))
                    / (4*((d2.getLatitud()-d1.getLatitud())*(d3.getLongitud()-d1.getLongitud())-(d3.getLatitud()-d1.getLatitud())
                    *(d2.getLongitud()-d1.getLongitud())));
